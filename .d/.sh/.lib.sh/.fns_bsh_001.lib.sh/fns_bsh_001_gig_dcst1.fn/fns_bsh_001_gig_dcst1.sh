...
fns_bsh_001_gig_dcst1(){

    local fl_pth_fn_17951_8089="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_dcst1.fn/fns_bsh_001_gig_dcst1.sh"
    local dr_pth_fn_17951_8089=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_dcst1.fn/fns_bsh_001_gig_dcst1.sh)
    local fl_nm_fn_17951_8089=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_dcst1.fn/fns_bsh_001_gig_dcst1.sh)
    local rnd=17951_8089
	...
	[[ "$1" == "-h" ]] && {
        ...
        doing :: 
			\$1 - gig dr fns_bsh_001_cst_\$1.fn in root fns_bsh_001 lib
			\$2 - 
			\$3 - 
            exa use ::
            far use ::
