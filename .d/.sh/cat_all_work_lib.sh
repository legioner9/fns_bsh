...
fn_32701_31284() {
	...
	local fl_pth_fn_32701_31284="${HOME}/fns_bsh/.d/.sh/cat_all_work_lib.sh"
	local dr_pth_fn_32701_31284=$(dirname ${HOME}/fns_bsh/.d/.sh/cat_all_work_lib.sh)
	local fl_nm_fn_32701_31284=$(basename ${HOME}/fns_bsh/.d/.sh/cat_all_work_lib.sh)
	local rnd=32701_31284
	...
	#     # snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/cat_all_work_lib.sh , line=${LINENO} :: ARG_1_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# 	# snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/cat_all_work_lib.sh , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
	...
	# . /home/st/fns_bsh/.d/.sh/cat_lib_fns_bsh_XXX.sh
	. $(eval "echo \$dr_pth_fn_${rnd}")/cat_lib_fns_bsh_XXX.sh

	# . /home/st/fns_bsh/.d/.p.ax/_cat_pXXX.sh

	. $(eval "echo \$prnt2_dr_pth_fn_${rnd}")/.d/.p.ax/_cat_pXXX.sh
