...
res(){
    ...
    local fl_pth_fn_15192_5691="${HOME}/fns_bsh/.d/.p.ax/.p015.d/.tst/g.tst.d/res.d/res.sh"
    local dr_pth_fn_15192_5691=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p015.d/.tst/g.tst.d/res.d/res.sh)
    local fl_nm_fn_15192_5691=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p015.d/.tst/g.tst.d/res.d/res.sh)
    local rnd=15192_5691
