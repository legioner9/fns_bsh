...
fns_bsh_002_puml2d.fnsh(){

	l_00_echo_code "start :: <${FUNCNAME[0]}>"

    local fl_pth_fn_11033_1172="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh.fnsh/fns_bsh_002_puml2d.fnsh.sh"
    local dr_pth_fn_11033_1172=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh.fnsh/fns_bsh_002_puml2d.fnsh.sh)
    local fl_nm_fn_11033_1172=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh.fnsh/fns_bsh_002_puml2d.fnsh.sh)
    local rnd=11033_1172

	# [[ -z "$2" ]] && {
	#     # snp "out_err"
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh.fnsh/fns_bsh_002_puml2d.fnsh.sh , line=${LINENO} :: ARG_2_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# [[ -d "$2" ]] || {
	# 	# snp "out_err"
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh.fnsh/fns_bsh_002_puml2d.fnsh.sh , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
