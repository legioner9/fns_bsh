...
l_00_echo_sys "fns_bsh_002_d2md_2 \
...
tree $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/.g.tst.d/res.d/$(eval "echo \$arg_1_fn_${rnd}")

#/home/st/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.dta/cp_to_tst.d/v1
