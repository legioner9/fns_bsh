...
# read -p "01 in ~/fns_bsh/.d/.p.ax/.p018.d/.us/002.us.sh"
...
# read -p "02 in ~/fns_bsh/.d/.p.ax/.p018.d/.us/002.us.sh"
...
# read -p "03 in ~/fns_bsh/.d/.p.ax/.p018.d/.us/002.us.sh"

echo -e "
# stck :: . $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/.p018.d/g.pr \
	$(eval "echo \$arg_1_fn_${rnd}")/$(eval "echo \$arg_2_fn_${rnd}")/.g.d \
	g.vis" >> \
...
# read -p "04 in ~/fns_bsh/.d/.p.ax/.p018.d/.us/002.us.sh"
...
# read -p "05 in ~/fns_bsh/.d/.p.ax/.p018.d/.us/002.us.sh"
