...
fn_5778_18921(){
    ...
    local fl_pth_fn_5778_18921="${HOME}/fns_bsh/.d/.p.ax/.p012.d/.tst/g.tst.d/res.d/start_make.sh"
    local dr_pth_fn_5778_18921=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p012.d/.tst/g.tst.d/res.d/start_make.sh)
    local fl_nm_fn_5778_18921=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p012.d/.tst/g.tst.d/res.d/start_make.sh)
    local rnd=5778_18921
	...
	#-- ~001_body~
	#* from:: ${HOME}/fns_bsh/.d/.p.ax/.p012.d/.dta/g_arg.dom.tml.d/001_body.tml
	# that 001_body
	#. $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr arg1 arg2
