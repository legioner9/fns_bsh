...
fn_vewthhg5231454gfvs00() {
    ...
    if [ "y" == "$yes" ]; then
        ...
        rm -rf ".d/.bcp_dpl/vs_code/Snippets"
        mkdir ".d/.bcp_dpl/vs_code/Snippets"
        cp -rv "$HOME/.config/VSCodium/User/snippets" ".d/.bcp_dpl/vs_code/Snippets"
        cp -fv "$HOME/.config/VSCodium/User/settings.json" ".d/.bcp_dpl/vs_code/settings.json"
    fi
