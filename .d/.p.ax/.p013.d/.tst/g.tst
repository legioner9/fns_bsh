...
fn_6483_8003(){
    ...
    local fl_pth_fn_6483_8003="${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst"
    local dr_pth_fn_6483_8003=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst)
    local fl_nm_fn_6483_8003=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst)
    local rnd=6483_8003
	...
	if [[ $flw == "dr" ]]; then
		...
		l_00_echo_info "example if infs for gig tst_result is :: [. g.pr prn_dr :!: .spc]"
		l_00_echo_code ". $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr $(eval "echo \$dr_pth_fn_${rnd}")/g.tst.d"
		. $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr $(eval "echo \$dr_pth_fn_${rnd}")/g.tst.d
...
# stck :: fns_bsh_001_als_gig_fl_sh /home/st/fns_bsh/.d/.p.ax/.p013.d/.tst 	g.tst 	~/fns_bsh/.d/.p.ax/.cmn/.cmn.tml.d/001.cmn.tml.d 	~/fns_bsh/.d/.p.ax/.dom/.dom.tml.d/003.dom.tml.d
