...
fns_bsh_002_d2md_2(){
    ...
    local fl_pth_fn_10503_27267="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/fns_bsh_002_d2md_2.sh"
    local dr_pth_fn_10503_27267=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/fns_bsh_002_d2md_2.sh)
    local fl_nm_fn_10503_27267=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/fns_bsh_002_d2md_2.sh)
    local rnd=10503_27267

	# [[ -z "$2" ]] && {
	#     # snp "out_err"
	#     l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'"
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/fns_bsh_002_d2md_2.sh , line=${LINENO} :: ARG_2_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# 	# snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'"
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/fns_bsh_002_d2md_2.sh , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
