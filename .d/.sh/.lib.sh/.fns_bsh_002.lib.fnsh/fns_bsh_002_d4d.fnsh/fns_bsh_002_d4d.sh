...
fns_bsh_002_d4d() {
	...
	local fl_pth_fn_32343_4159="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d4d.fnsh/fns_bsh_002_d4d.sh"
	local dr_pth_fn_32343_4159=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d4d.fnsh/fns_bsh_002_d4d.sh)
	local fl_nm_fn_32343_4159=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d4d.fnsh/fns_bsh_002_d4d.sh)
	local rnd=32343_4159
	...
	[[ -d "$1" ]] || {
		# snp "out_err"
		echo -e "${ECHO_RET1}in file://$fn_nm_fn_2219_9919 , line=${LINENO} :: ARG_1_NOT_DR , return 1${NRM}" >&2
		return 1
	}

	l_00_echo_code "[[ -d file://$(dirname "$2") ]]"

	[[ -d $(dirname "$2") ]] || {
		# snp "out_err"
		echo -e "${ECHO_RET1}in file://$fn_nm_fn_2219_9919 , line=${LINENO} :: ARG_2_NOT_DR , return 1${NRM}" >&2
		return 1
	}
