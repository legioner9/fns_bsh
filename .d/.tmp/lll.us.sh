...
fn_3896_792(){
    ...
    local fl_pth_fn_3896_792="${HOME}/fns_bsh/.d/.tmp/lll.us.sh"
    local dr_pth_fn_3896_792=$(dirname ${HOME}/fns_bsh/.d/.tmp/lll.us.sh)
    local fl_nm_fn_3896_792=$(basename ${HOME}/fns_bsh/.d/.tmp/lll.us.sh)
    local rnd=3896_792
