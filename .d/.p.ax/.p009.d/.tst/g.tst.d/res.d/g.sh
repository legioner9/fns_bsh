...
fn_9002_4763(){
    ...
    local fl_pth_fn_9002_4763="${HOME}/fns_bsh/.d/.p.ax/.p009.d/.tst/g.tst.d/res.d/g.sh"
    local dr_pth_fn_9002_4763=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p009.d/.tst/g.tst.d/res.d/g.sh)
    local fl_nm_fn_9002_4763=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p009.d/.tst/g.tst.d/res.d/g.sh)
    local rnd=9002_4763
