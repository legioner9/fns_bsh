...
# !echo -e "
# ! stck :: l_02_s2f {{fl_nm}} ${fl_nm} ${fl_nm}" >> ${fl_nm}
...
l_00_echo_code "l_02_s2f {{head}} ${fn_nm_ins} ${fl_nm}"
l_02_s2f "{{head}}" "${fn_nm_ins}" "${fl_nm}"
...
local res_fl_nm=$(eval "echo \$arg_1_fn_${rnd}")/$(eval "echo \$arg_2_fn_${rnd}")
l_00_echo_code ". $res_fl_nm"
. $res_fl_nm