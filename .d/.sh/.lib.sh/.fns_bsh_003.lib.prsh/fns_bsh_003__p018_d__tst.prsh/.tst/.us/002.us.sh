...
l_00_echo_sys ". $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.sh $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/.g.tst.d/res.d init.puml"
. $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.sh $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/.g.tst.d/res.d init.puml
