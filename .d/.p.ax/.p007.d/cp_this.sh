...
fn_2621_21023() {
	...
	local fl_pth_fn_2621_21023="${HOME}/fns_bsh/.d/.p.ax/.p007.d/cp_this.sh"
	local dr_pth_fn_2621_21023=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p007.d/cp_this.sh)
	local fl_nm_fn_2621_21023=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p007.d/cp_this.sh)
