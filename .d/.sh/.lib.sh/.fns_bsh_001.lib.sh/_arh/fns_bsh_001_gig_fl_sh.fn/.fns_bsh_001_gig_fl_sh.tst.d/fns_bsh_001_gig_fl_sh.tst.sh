...
fn_1599_7293(){
    ...
    local fl_pth_fn_1599_7293="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/.fns_bsh_001_gig_fl_sh.tst.d/fns_bsh_001_gig_fl_sh.tst.sh"
    local dr_pth_fn_1599_7293=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/.fns_bsh_001_gig_fl_sh.tst.d/fns_bsh_001_gig_fl_sh.tst.sh)
    local fl_nm_fn_1599_7293=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/.fns_bsh_001_gig_fl_sh.tst.d/fns_bsh_001_gig_fl_sh.tst.sh)
    local rnd=1599_7293
