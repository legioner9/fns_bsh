...
fns_bsh_002_puml2d() {
	...
	local fl_pth_fn_4505_11074="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh/fns_bsh_002_puml2d.sh"
	local dr_pth_fn_4505_11074=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh/fns_bsh_002_puml2d.sh)
	local fl_nm_fn_4505_11074=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh/fns_bsh_002_puml2d.sh)
	local rnd=4505_11074
...
"
	...
	[[ -d "$1" ]] || {
		# snp "out_err"
		echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh/fns_bsh_002_puml2d.sh , line=${LINENO} :: ARG_1_NOT_DR is *{REN}, return 1${NRM}" >&2
		return 1
	}

	[[ -n "$4" ]] || {
		# snp "out_err"
		echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_puml2d.fnsh/fns_bsh_002_puml2d.sh , line=${LINENO} :: ARG_4_NOT_DEFINE is flow_char, return 1${NRM}" >&2
		return 1
	}
