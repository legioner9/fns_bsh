...
fn_24859_22367(){
    ...
    local fl_pth_fn_24859_22367="${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst.d/.spc/.spc.sh"
    local dr_pth_fn_24859_22367=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst.d/.spc/.spc.sh)
    local fl_nm_fn_24859_22367=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p013.d/.tst/g.tst.d/.spc/.spc.sh)
    local rnd=24859_22367
...
# from:: ~/fns_bsh/.d/.p.ax/.cmn/.cmn.tml.d/002.cmn.tml.d/001_key.tml
	...
	#-- ~001_body~
	# from:: ~/fns_bsh/.d/.p.ax/.dom/.dom.tml.d/005.dom.tml.d/001_body.tml
	# for .spc
