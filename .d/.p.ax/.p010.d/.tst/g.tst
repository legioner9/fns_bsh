...
fn_26581_18051() {
	...
	local fl_pth_fn_26581_18051="${HOME}/fns_bsh/.d/.p.ax/.p010.d/.tst/g.tst"
	local dr_pth_fn_26581_18051=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p010.d/.tst/g.tst)
	local fl_nm_fn_26581_18051=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p010.d/.tst/g.tst)
	local rnd=26581_18051
	...
	l_00_echo_info "example if infs for gig tst_result is :: [. g.pr dr_res res.d]"
	l_00_echo_code "	. $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr \
		$(eval "echo \$dr_pth_fn_${rnd}")/g.tst.d \
		res.d"
