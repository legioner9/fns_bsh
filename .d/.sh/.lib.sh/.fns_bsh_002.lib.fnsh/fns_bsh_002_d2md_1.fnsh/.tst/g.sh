...
fn_7629_31195(){
    ...
    local fl_pth_fn_7629_31195="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.tst/g.sh"
    local dr_pth_fn_7629_31195=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.tst/g.sh)
    local fl_nm_fn_7629_31195=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.tst/g.sh)
    local rnd=7629_31195
...
# from:: ~/fns_bsh/.d/.p.ax/.cmn/.cmn.tml.d/002.cmn.tml.d/001_key.tml
	...
	[[ -z "$1" ]] && {
	    # snp "out_err"
		l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'"
	    echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.tst/g.sh , line=${LINENO} :: ARG_1_NOT_DEFINE is tst_dr in /.g.tst.d/res.d exa::v1 , return 1 ${NRM}" >&2
	    return 1
	}
	...
	# 	# snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_1.fnsh/.tst/g.sh , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }	
