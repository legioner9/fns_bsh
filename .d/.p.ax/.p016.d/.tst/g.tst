...
fn_5001_2212() {
	...
	local fl_pth_fn_5001_2212="${HOME}/fns_bsh/.d/.p.ax/.p016.d/.tst/g.tst"
	local dr_pth_fn_5001_2212=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p016.d/.tst/g.tst)
	local fl_nm_fn_5001_2212=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p016.d/.tst/g.tst)
	local rnd=5001_2212
	...
	# [[ -z "$1" ]] && {
	#     # snp "out_err"
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p016.d/.tst/g.tst , line=${LINENO} :: ARG_1_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# [[ -d "$2" ]] || {
	# 	# snp "out_err"
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p016.d/.tst/g.tst , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
	...
	if [[ $flw == "dr" ]]; then
		...
		mkdir -p $(eval "echo \$dr_pth_fn_${rnd}")/g.tst.d/res.d/res_1.d

		l_00_echo_info ""
		l_00_echo_code ". $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr $(eval "echo \$dr_pth_fn_${rnd}")/g.tst.d/res.d/res_1.d"
...
# stck :: fns_bsh_001_als_gig_fl_sh /home/st/fns_bsh/.d/.p.ax/.p016.d/.tst 	g.tst 	~/fns_bsh/.d/.p.ax/.cmn/.cmn.tml.d/001.cmn.tml.d 	~/fns_bsh/.d/.p.ax/.dom/.dom.tml.d/003.dom.tml.d
