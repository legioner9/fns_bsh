...
if [[ $(eval "echo \$flow_1_${rnd}") == "dr" ]]; then
	...
	. ~/fns_bsh/.d/.p.ax/.p009.d/g.pr $(eval "echo \$arg_1_fn_${rnd}") $(eval "echo \$arg_2_fn_${rnd}") -v2
	l_00_echo_err "CHECK! . ~/fns_bsh/.d/.p.ax/.p009.d/g.pr $(eval "echo \$arg_1_fn_${rnd}") $(eval "echo \$arg_2_fn_${rnd}") -v2"
	read -p "1"
