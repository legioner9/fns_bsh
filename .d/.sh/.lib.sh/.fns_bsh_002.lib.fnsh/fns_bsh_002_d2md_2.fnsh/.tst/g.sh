...
fn_16818_11231() {
	...
	local fl_pth_fn_16818_11231="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh"
	local dr_pth_fn_16818_11231=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh)
	local fl_nm_fn_16818_11231=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh)
	local rnd=16818_11231
	...
	[[ -z "$1" ]] && {
		# snp "out_err"
		l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'"
		echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh , line=${LINENO} :: ARG_1_NOT_DEFINE is tst_dr in /.g.tst.d/res.d exa::v6 , return 1 ${NRM}" >&2
		return 1
	}
	...
	#     # snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh , line=${LINENO} :: ARG_1_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# 	# snp "out_err"
	# 	l_00_echo_code "exit :: <${FUNCNAME[0]}> '$@'
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh/fns_bsh_002_d2md_2.fnsh/.tst/g.sh , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
