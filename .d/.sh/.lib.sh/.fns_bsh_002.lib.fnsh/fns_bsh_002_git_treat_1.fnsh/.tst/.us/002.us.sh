...
l_00_echo_sys "$(l_01_prs_f -n "$(eval "echo \$prnt1_dr_pth_fn_${rnd}")") $HOME/fns_bsh/.d/.cdn.ax/.env.sh/fns_bsh_002_git_treat_1.v1.env.sh"
$(l_01_prs_f -n "$(eval "echo \$prnt1_dr_pth_fn_${rnd}")") "$HOME/fns_bsh/.d/.cdn.ax/.env.sh/fns_bsh_002_git_treat_1.v1.env.sh"
