...
fn_23298_13162() {
	...
	local fl_pth_fn_23298_13162="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/_gig_fn_fns_bsh_001.arg.sh"
	local dr_pth_fn_23298_13162=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/_gig_fn_fns_bsh_001.arg.sh)
	local fl_nm_fn_23298_13162=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/_gig_fn_fns_bsh_001.arg.sh)
	local rnd=23298_13162
	...
	[[ -z "$1" ]] && {
		# snp "out_err"
		echo -e "${ECHO_RET1}in file://$fn_nm_fn_2219_9919 , line=${LINENO} :: ARG_2_NOT_DEFINE is `\$1 - gig dr fns_bsh_001_\$1.fn in root fns_bsh_001 lib`, return 1${NRM}" >&2
		return 1
	}
	...
	eval "local exec_str_${rnd}=\"~/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/_gig_fn_fns_bsh_001.sh \$1\""

	# . ~/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/_gig_fn_fns_bsh_001.sh \
	# tmp
	eval "echo \$(date) >> \$dr_pth_fn_${rnd}/_gig_fn_fns_bsh_001.arg.lgs"
	eval "echo \$exec_str_${rnd} >> \$dr_pth_fn_${rnd}/_gig_fn_fns_bsh_001.arg.lgs"

	eval "echo \\\$exec_str_${rnd}=\$exec_str_${rnd}"

	# eval "\$exec_str_${rnd}"

	# eval "eval \". \$exec_str_${rnd}\""
	l_00_echo_code "eval \\\". \\\$exec_str_\${rnd}\""
	eval "eval \". \$exec_str_${rnd}\""
