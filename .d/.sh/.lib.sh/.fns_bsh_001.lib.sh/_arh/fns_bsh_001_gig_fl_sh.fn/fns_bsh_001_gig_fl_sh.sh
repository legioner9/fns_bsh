...
fns_bsh_001_gig_fl_sh(){

    local fl_pth_fn_8287_7651="${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/fns_bsh_001_gig_fl_sh.sh"
    local dr_pth_fn_8287_7651=$(dirname ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/fns_bsh_001_gig_fl_sh.sh)
    local fl_nm_fn_8287_7651=$(basename ${HOME}/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_001.lib.sh/fns_bsh_001_gig_fl_sh.fn/fns_bsh_001_gig_fl_sh.sh)
    local rnd=8287_7651
