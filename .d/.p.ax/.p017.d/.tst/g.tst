...
fn_24623_32386() {
	...
	local fl_pth_fn_24623_32386="${HOME}/fns_bsh/.d/.p.ax/.p017.d/.tst/g.tst"
	local dr_pth_fn_24623_32386=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p017.d/.tst/g.tst)
	local fl_nm_fn_24623_32386=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p017.d/.tst/g.tst)
	local rnd=24623_32386
	...
	# [[ -z "$1" ]] && {
	#     # snp "out_err"
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p017.d/.tst/g.tst , line=${LINENO} :: ARG_1_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# [[ -d "$2" ]] || {
	# 	# snp "out_err"
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p017.d/.tst/g.tst , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }
	...
	if [[ $flw == "dr" ]]; then
		...
		. $(eval "echo \$prnt1_dr_pth_fn_${rnd}")/g.pr ~/fns_bsh/.d/.sh/.lib.sh/.fns_bsh_002.lib.fnsh fns_bsh_002__p015_d__tst.fnsh
...
# stck :: fns_bsh_001_als_gig_fl_sh /home/st/fns_bsh/.d/.p.ax/.p017.d/.tst 	g.tst 	~/fns_bsh/.d/.p.ax/.cmn/.cmn.tml.d/001.cmn.tml.d 	~/fns_bsh/.d/.p.ax/.dom/.dom.tml.d/003.dom.tml.d
