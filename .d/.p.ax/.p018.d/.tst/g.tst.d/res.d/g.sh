...
fn_23387_25222(){
    ...
    local fl_pth_fn_23387_25222="${HOME}/fns_bsh/.d/.p.ax/.p018.d/.tst/g.tst.d/res.d/g.sh"
    local dr_pth_fn_23387_25222=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p018.d/.tst/g.tst.d/res.d/g.sh)
    local fl_nm_fn_23387_25222=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p018.d/.tst/g.tst.d/res.d/g.sh)
