...
fn_14268_3111() {
	...
	local fl_pth_fn_14268_3111="${HOME}/fns_bsh/.d/.p.ax/_cmn_dom_readline.sh"
	local dr_pth_fn_14268_3111=$(dirname ${HOME}/fns_bsh/.d/.p.ax/_cmn_dom_readline.sh)
	local fl_nm_fn_14268_3111=$(basename ${HOME}/fns_bsh/.d/.p.ax/_cmn_dom_readline.sh)
	local rnd=14268_3111
