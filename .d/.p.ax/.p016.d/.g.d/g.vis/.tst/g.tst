...
fn_26020_30823(){
    ...
    local fl_pth_fn_26020_30823="${HOME}/fns_bsh/.d/.p.ax/.p016.d/.g.d/g.vis/.tst/g.tst"
    local dr_pth_fn_26020_30823=$(dirname ${HOME}/fns_bsh/.d/.p.ax/.p016.d/.g.d/g.vis/.tst/g.tst)
    local fl_nm_fn_26020_30823=$(basename ${HOME}/fns_bsh/.d/.p.ax/.p016.d/.g.d/g.vis/.tst/g.tst)
    local rnd=26020_30823
	...
	# [[ -z "$1" ]] && {
	#     # snp "out_err"
	#     echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p016.d/.g.d/g.vis/.tst/g.tst , line=${LINENO} :: ARG_1_NOT_DEFINE is ..., return 1${NRM}" >&2
	#     return 1
	# }
	...
	# [[ -d "$2" ]] || {
	# 	# snp "out_err"
	# 	echo -e "${ECHO_RET1}in file://${HOME}/fns_bsh/.d/.p.ax/.p016.d/.g.d/g.vis/.tst/g.tst , line=${LINENO} :: ARG_2_NOT_DR is ..., return 1${NRM}" >&2
	# 	return 1
	# }	
